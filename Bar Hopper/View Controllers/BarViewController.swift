...
class BarViewController: UIViewController, CLLocationManagerDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            //MAKE API CALL HERE
            let urlString = "https://barhopperapi.herokuapp.com/api/bars/loc/%5B" + longString + ",%20" + latString + "%5D"
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Bar", for: indexPath) as! BarCollectionViewCell
        ...
        let name: String = promotionInfo["name"]! as! String
        cell.nameLabel.text = name
        let barID: String = promotionInfo["_id"]! as! String
        cell.barID = barID
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let barID: String = promotionInfo["_id"]! as! String
        self.dataToPass = [barID]
        
        performSegue(withIdentifier: "Bar Promotions Segue", sender: self)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any!) {
        
        if segue.identifier == "Bar Promotions Segue" {
            
            let barPromotionViewController: BarPromotionViewController = segue.destination as! BarPromotionViewController
            
            barPromotionViewController.dataPassed = dataToPass
        }
    }
